...
/**
 */
@javax.annotation.Generated(value = "by gRPC proto compiler (version 1.64.0)", comments = "Source: user/v1/user.proto")
...
public final class UserServiceGrpc {
    ...
    private static volatile io.grpc.MethodDescriptor<user.v1.GetUserRequest, user.v1.GetUserResponse> getGetUserMethod;
    ...
    public static io.grpc.MethodDescriptor<user.v1.GetUserRequest, user.v1.GetUserResponse> getGetUserMethod() {
    ...
    private static volatile io.grpc.MethodDescriptor<user.v1.DeleteUserRequest, user.v1.DeleteUserResponse>
            getDeleteUserMethod;
    ...
    @io.grpc.stub.annotations.RpcMethod(
            ...
            methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
    public static io.grpc.MethodDescriptor<user.v1.DeleteUserRequest, user.v1.DeleteUserResponse>
            getDeleteUserMethod() {
    ...
    public interface AsyncService {
        ...
        default void getUser(
                user.v1.GetUserRequest request, io.grpc.stub.StreamObserver<user.v1.GetUserResponse> responseObserver) {
     ...
     */
    public abstract static class UserServiceImplBase implements io.grpc.BindableService, AsyncService {
        ...
        return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
                .addMethod(
                        ...
                        io.grpc.stub.ServerCalls.asyncUnaryCall(new MethodHandlers<
                                user.v1.GetUserRequest, user.v1.GetUserResponse>(service, METHODID_GET_USER)))
                .addMethod(
                        getDeleteUserMethod(),
                        io.grpc.stub.ServerCalls.asyncUnaryCall(new MethodHandlers<
                                user.v1.DeleteUserRequest, user.v1.DeleteUserResponse>(service, METHODID_DELETE_USER)))
                .build();
    }
    ...
    private static final class UserServiceMethodDescriptorSupplier extends UserServiceBaseDescriptorSupplier
