...
Source code is available at [webmvc](https://github.com/DanielLiu1123/grpc-starter/tree/main/examples/transcoding/webmvc).

## Server Streaming

Support server streaming API:
...
This API can be called by HTTP:
