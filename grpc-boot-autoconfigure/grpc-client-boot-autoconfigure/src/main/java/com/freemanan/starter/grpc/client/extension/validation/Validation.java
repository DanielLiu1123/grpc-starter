package com.freemanan.starter.grpc.client.extension.validation;
...
@ConditionalOnProperty(prefix = GrpcClientProperties.Validation.PREFIX, name = "enabled", matchIfMissing = true)
