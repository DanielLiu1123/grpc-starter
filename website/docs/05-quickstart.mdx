...
:::tip
For how to set up the project: <br/>
Gradle users can refer to [multi-module-example](https://github.com/DanielLiu1123/grpc-starter/tree/main/examples/multi-module). <br/>
Maven users can refer to [grpc-starter-maven-demo](https://github.com/DanielLiu1123/grpc-starter-maven-demo).
:::
